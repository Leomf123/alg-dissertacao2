...
def adicionarMaxMST(matriz_adjacencia, matriz_distancia):
...
def MaxMknn(dados, matriz_distancia, medida_distancia, k):
    ...
    matriz_adjacencia = adicionarMaxMST(matriz_adjacencia, matriz_distancia)
