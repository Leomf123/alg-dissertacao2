...
def adicionarMinMST(matriz_adjacencia, matriz_distancia):
...
def MinMknn(dados, matriz_distancia, medida_distancia, k):
    ...
    matriz_adjacencia = adicionarMinMST(matriz_adjacencia, matriz_distancia)
